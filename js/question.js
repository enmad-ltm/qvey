...
$('button[name=regBtn]').on('click', function(){
  ...
  if(crtTab == 'privacy') {
    ...
    $(pushId[1]+' #s-groupRelative').append(addHtml)
  }
  ++delCnt;
});
